...
const markerPath = (shape: ProminenceSeries["marker"], cx: number, cy: number) => shape === "square" ? `M${cx - 6},${cy - 6}h12v12h-12z` : shape === "triangle" ? `M${cx},${cy - 7}l7,13h-14z` : shape === "diamond" ? `M${cx},${cy - 8}l8,8-8,8-8-8z` : shape === "cross" ? `M${cx - 2},${cy - 8}h4v6h6v4h-6v6h-4v-6h-6v-4h6z` : `M${cx},${cy}m-6,0a6,6 0 1,0 12,0a6,6 0 1,0-12,0`;
